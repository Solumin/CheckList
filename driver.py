...
parser = argparse.ArgumentParser(
    ...
    epilog=(
        "--new and --load are mutually exclusive."
...
megroup.add_argument(
    "-n", "--new", action="store_true", help="start with an empty checklist"
)
megroup.add_argument("-l", "--load", help="start with the list in LIST", metavar="LIST")
